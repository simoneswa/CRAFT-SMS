    ...
    <div className="space-y-8 max-w-6xl mx-auto py-12 px-6">
       <div className="flex justify-between items-end mb-12">
          <div>
             ...
             <p className="text-[10px] text-gray-500 font-bold uppercase tracking-[0.3em] mt-2 italic">Operational Certification v1.0 • CRAFT SMS Production Stream</p>
          </div>
       ...
       <div className="grid grid-cols-4 gap-6">
          {[
             ...
             { label: 'Failed Background Jobs', value: metrics.failed_jobs, icon: Terminal, color: 'text-gray-400' },
       ...
       <div className="grid grid-cols-2 gap-8 pt-8">
          <div className="p-8 bg-white/[0.01] border border-white/5 rounded-3xl space-y-8">
             <h3 className="text-xs font-black uppercase tracking-[0.3em] text-gray-400 border-b border-white/5 pb-4">Infrastructure Certification</h3>
             {[
                ...
                <div key={i} className="flex justify-between items-center group">
                   <div>
                      ...
                      <p className="text-[10px] text-gray-600 font-bold uppercase tracking-widest mt-1">{row.desc}</p>
                   </div>
          ...
          <div className="p-8 bg-white/[0.01] border border-white/5 rounded-3xl space-y-8">
             <h3 className="text-xs font-black uppercase tracking-[0.3em] text-gray-400 border-b border-white/5 pb-4">Disaster Recovery Readiness</h3>
             <div className="space-y-6">
                <div className="flex items-center gap-4 p-4 bg-white/[0.02] border border-white/5 rounded-2xl">
                   ...
                   <div>
                      ...
                      <p className="text-[10px] text-gray-600 font-bold uppercase tracking-widest mt-1">Status: Geographically Redundant</p>
                   </div>
                </div>
                <div className="flex items-center gap-4 p-4 bg-white/[0.02] border border-white/5 rounded-2xl opacity-60">
                   ...
                   <div>
                      ...
                      <p className="text-[10px] text-gray-600 font-bold uppercase tracking-widest mt-1">14 minutes ago (Logical Snap)</p>
                   </div>
                </div>
             </div>
          </div>
