      ...
      <div className="premium-card bg-[var(--edlink-green-brand)]/5 border-[var(--edlink-green-brand)]/10">
         <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex gap-2">
               <button className="px-3 py-1.5 rounded-lg bg-[var(--edlink-green-brand)] text-black text-[10px] font-black uppercase">Sarah</button>
               <button className="px-3 py-1.5 rounded-lg bg-white/5 text-[var(--edlink-blue-text)]/70 text-[10px] font-black uppercase hover:bg-white/10 transition-all">Michael</button>
            </div>
         </div>
         <div className="grid grid-cols-2 gap-4">
            ...
            <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/5">
               ...
               <p className="text-xl font-bold text-[var(--edlink-green-brand)]">92.4%</p>
            </div>
         </div>
      </div>
              ...
              { type: 'FINANCE', msg: 'Term 1 Fee slip verified successfully', time: '2d ago', icon: CreditCard, color: 'emerald' },
               ...
               <div key={i} className="flex gap-4 p-4 bg-white/[0.02] border border-white/5 rounded-2xl">
                  ...
                  <div className="flex-1">
                     ...
                     <p className="text-[10px] text-[var(--edlink-blue-text)]/70 font-bold uppercase tracking-widest">{activity.time}</p>
                  </div>
               </div>
            ))}
         </div>
